...
//      Serial.print(PS3.getAngle(Pitch));
      Serial.print(PS3.getSensor(aX));
      Serial.print(F("\tY: "));
//      Serial.print(PS3.getAngle(Roll));
      Serial.print(PS3.getSensor(aY));
        Serial.print(F("\tZ: "));
//      Serial.print(PS3.getAngle(Roll));
      Serial.print(PS3.getSensor(aZ));
    }
#endif
  }
    ...
    if (printAngle) {
      Serial.print(F("\r\nX: "));
      Serial.print(PS3.getSensor(aXmove));
      Serial.print(F("\tY: "));
      Serial.print(PS3.getSensor(aYmove));
       Serial.print(F("\tZ: "));
      Serial.print(PS3.getSensor(aZmove));
    }
